...
define('TIMEWOBBLE_PLUGIN_VERSION', 1);
define('MMDB_PATH', plugin_dir_path(__FILE__). 'mmdb/GeoLite2-City.mmdb');
define('TIMEZONES_PATH', plugin_dir_path(__FILE__). '/timezones.json');
